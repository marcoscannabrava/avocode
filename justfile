...
lint:
    ...
    shellcheck -S style bin/avo test/e2e.sh test/e2e-score.sh test/e2e-lineage.sh test/e2e-mem.sh test/e2e-know.sh test/e2e-install.sh test/e2e-fan.sh templates/score/*.sh ralph.sh test/ralph_test.sh || echo "shellcheck: skipped (not installed)"
