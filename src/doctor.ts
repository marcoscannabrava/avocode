...
export const DEPS: readonly DepSpec[] = [
  ...
  { name: "qmd", kind: "optional", why: "knowledge base K: hybrid search + local rerank (S4)", install: "npm i -g @tobilu/qmd" },
...
export const KEYS: readonly { name: string; why: string }[] = [
  ...
  { name: "FIRECRAWL_API_KEY", why: "avo know add|search default backend (S4)" },
